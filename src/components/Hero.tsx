    ...
    <header className="hero" id="hero">
      <div className="wrap">
        <HeroReveal>
          ...
          <HeroChild>
            <p>
              Impulsione o seu negócio com IA — da operação ao atendimento.
            </p>
          </HeroChild>
          <HeroChild>
            <div className="hero-cta">
              <a href={`${WHATSAPP_LINK}?text=Oi!%20Vim%20pelo%20site%20e%20quero%20fazer%20um%20teste%20da%20IAlem%20na%20prática`} target="_blank" className="btn btn-primary">
                Testar na Prática
              </a>
              <a href={`${WHATSAPP_LINK}?text=Oi!%20Quero%20agendar%20um%20diagnóstico%20gratuito%20para%20minha%20empresa`} target="_blank" className="btn btn-ghost">
                Agendar diagnóstico
              </a>
            </div>
          </HeroChild>
