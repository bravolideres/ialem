        ...
        <div className="cta-big cta-with-image">
          ...
          <div className="cta-content">
            ...
            <div className="cta-buttons" style={{ display: "flex", justifyContent: "center", gap: 14, flexWrap: "wrap" }}>
              ...
              <a href="https://wa.me/556992074081?text=Oi!%20Quero%20agendar%20um%20diagnóstico%20gratuito%20para%20minha%20empresa" target="_blank" className="btn btn-ghost">
                Agendar diagnóstico
              </a>
            </div>
          </div>
